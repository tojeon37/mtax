...
class CompanyService:
    ...
    def register_barobill_member(
        ...
        Returns:
            성공 여부
        """
        if not user_data.get("business_no") or not user_data.get("company_name") or not user_data.get("email"):
            return False
        ...
        try:
            ...
            barobill_service.regist_corp_member(
                ...
                corp_name=user_data.get("company_name") or user_data.get("biz_name") or "",
                ...
                addr2="",
                member_name=user_data.get("manager_name") or user_data.get("ceo_name") or "",
